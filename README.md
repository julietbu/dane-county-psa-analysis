...
# Code
- `code/analysis.do`: Main Stata do-file that runs the full analysis.
  The script cleans the data, generates all variables, and produces
  the regression output used in the paper.

# Output

- `output/analysis.log`: Stata log file capturing all output generated
  by `analysis.do`, including summary statistics and regression results.

# Paper

- `paper/final_paper.pdf`: Final written report describing the research
